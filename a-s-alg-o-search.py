...
for shuffle_letter in custom_shuffle:
				if shuffle_letter=='w':
						grid_start[(br+0)%4][bc] = grid_start[(br+1)%4][bc]
						grid_start[(br+1)%4][bc] = grid_start[(br+2)%4][bc]
						grid_start[(br+2)%4][bc] = grid_start[(br+3)%4][bc]
						grid_start[(br-1)%4][bc] = "_"
						visualize(grid_start, 3)
						br=(br-1)%4
				...
				if shuffle_letter=='a':
						grid_start[br][(bc+0)%4] = grid_start[br][(bc+1)%4]
						grid_start[br][(bc+1)%4] = grid_start[br][(bc+2)%4]
						grid_start[br][(bc+2)%4] = grid_start[br][(bc+3)%4]
						grid_start[br][(bc-1)%4]= "_"
						visualize(grid_start, 3)
						bc=(bc-1)%4
